...
Open Landing Page
    ...
    Click Element    link=TNRS Application
    Wait Until Page Contains Element    link=Click here for support

Verify Title text
    [Tags]    GUI    smoke
    Switch Browser    ${BrowserAlias}
    Page Should Contain    Taxonomic Name Resolution Service
    Page Should Contain    v${TNRSVer}
